...
class Contractor {
    ...
    private var builderType: BuilderType = BuilderType.simple
}

extension Contractor {
    func setBuilder(_ builder: Builder, builderType: BuilderType) {
        self.builder = builder
        self.builderType = builderType
    }
    
    func buildSimpleHouse() -> House {
        switch builderType {
        case .complex:
